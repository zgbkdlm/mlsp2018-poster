...
\begin{minipage}[t]{\linewidth}
	\centering
	\includegraphics[width=0.4\linewidth]{figures/1012}
	\includegraphics[width=0.4\linewidth]{figures/kalman-1012-smooth-large}
	\includegraphics[width=0.4\linewidth]{figures/3246}
	\includegraphics[width=0.4\linewidth]{figures/ave-af-3246}
	\\\small Normal (Rec.1012, top) and Atrial Fibrillation (Rec.3246, bottom)\\
	\vspace{5mm}
	\includegraphics[width=0.247\linewidth]{figures/1037}
	\includegraphics[width=0.245\linewidth]{figures/ave-other-1037}
